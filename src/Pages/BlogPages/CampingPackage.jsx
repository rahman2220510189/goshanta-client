...
const CampingPackage = () => {
    ...
    return (
        ...
        <div className=" max-w-6xl mt-16 mx-auto p-6">
            <h2 className="text-3xl font-bold text-yellow-50 mb-8 text-center">Camping Package</h2>
  ...
  <div key={i} className="bg-yellow-50 rounded-lg shadow hover:shadow-xl transition-transform duration-500 overflow-hidden hover:scale-105">
    <img src={pkg.image_url} alt={pkg.package_name} className="w-full h-72 object-cover" />
    <div className="p-4">
